...
class GoogleSheetV1:
    def __init__(self):
        ...
        self.service = self.get_spreadsheet_service(service_key_file)
        self.data = None
    ...
    def get_sheet_values(self, service, spreadsheet_id, range_name):
        try:
            result = (
    ...
    def add_sheet_values(self, data, tag, header, sheet_values):
    ...
    def getLeetcodeData(self):
        ...
        for i, sheet_name in enumerate(sheet_names):
            vals = self.get_sheet_values(self.service, spreadsheet_id, f"'{sheet_name}'!A:M")
            self.add_sheet_values(data, tags[i], header, vals)
        return data
